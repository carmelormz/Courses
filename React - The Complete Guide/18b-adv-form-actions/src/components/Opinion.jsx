...
export function Opinion({ opinion: { id, title, body, userName, votes } }) {
  ...
  const disableButtons = upvotePending || downvotePending;
  ...
  return (
    <article>
      ...
      <form className='votes'>
        <button formAction={upvoteFormAction} disabled={disableButtons}>
          <svg
        ...
        <button formAction={downvoteFormAction} disabled={disableButtons}>
          <svg
            xmlns='http://www.w3.org/2000/svg'
            width='24'
            height='24'
